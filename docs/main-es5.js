...
var FormActionTextsComponent = /** @class */ (function () {
    function FormActionTextsComponent(authService) {
    ...
    FormActionTextsComponent.ctorParameters = function () { return [
...
var LoginFormComponent = /** @class */ (function () {
    function LoginFormComponent(formBuild, authService) {
...
var SignUpFormComponent = /** @class */ (function () {
    function SignUpFormComponent(formBuild, authService) {
        this.formBuild = formBuild;
        this.authService = authService;
...
var apiKeys = 'AIzaSyD-sHjvR3PkMiatG0fmGre1fxnJidcGEvY';
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signUpUser = function (email, password) {
        ...
        this.http.post(this.signUpEndpoint, {
            ...
            _this.signedUpSubj.next(true);
            _this.signUpLoaderSubj.next(true);
        }, function () {
            console.log(_this.firebaseAPIKey);
            _this.signedUpSubj.next(_this.failedSignUpMessage);
            _this.signUpLoaderSubj.next(true);
        });
    };
    AuthService.prototype.logInUser = function (email, password) {
        ...
        this.http.post(this.logInEndpoint, {
            ...
            var requestMomentDate = new Date().getTime();
            localStorage.setItem('requestMomentDate', String(requestMomentDate));
            localStorage.setItem('tokenExpiry', data.expiresIn);
            _this.loggedInSubj.next(true);
            _this.logInLoaderSubj.next(true);
            _this.router.navigate(['/home']);
        }, function () {
            _this.loggedInSubj.next(_this.failedLogInMessage);
            _this.logInLoaderSubj.next(true);
        });
    };
